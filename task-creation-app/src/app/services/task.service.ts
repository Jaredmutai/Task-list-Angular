...
export class TaskService {
  ...
  hasTaskWithTitleAndDescriptionEndingWithFunctionRegex(
    title: string, 
    description: string, 
    titleFn: (title: string) => boolean, 
    descriptionFn: (description: string) => boolean,
  ...
  hasTaskWithTitleOrDescriptionEndingWithFunctionRegex(
    title: string, 
    description: string, 
    titleFn: (title: string) => boolean, 
    descriptionFn: (description: string) => boolean,
  ...
  hasTaskWithTitleAndDescriptionEndingWithFunctionRegexCaseInsensitive(
    title: string, 
    description: string, 
    titleFn: (title: string) => boolean, 
    descriptionFn: (description: string) => boolean,
  ...
  hasTaskWithTitleOrDescriptionEndingWithFunctionRegexCaseInsensitive(
    title: string, 
    description: string, 
    titleFn: (title: string) => boolean, 
    descriptionFn: (description: string) => boolean,
